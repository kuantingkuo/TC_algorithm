...
INTEGER, PARAMETER    :: domainsize_y = 192 !102 !192
...
REAL, PARAMETER       :: lat_first = -90. !-47.5916230366492 ! -90.
REAL, PARAMETER       :: lat_inc = 0.94240837696335078534031413612565
REAL, PARAMETER       :: lon_inc = 1.25
...
INTEGER, PARAMETER    :: time_steps = 241    ! total number of timesteps
